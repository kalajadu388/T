...
TOKEN = '7948133420:AAHNl-f8Cc9sZGx-lzkCRbSgaGSx6nv10QE'
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACCESS:-@@TECHNO_MODE*", parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :-@@TECHNO_MODE*", parse_mode='Markdown')
